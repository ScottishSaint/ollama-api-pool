                    ...
                    <div class="rounded-3xl border border-slate-200 bg-white shadow-soft p-7 sm:p-8 space-y-6">
                        ...
                        <form id="login-form" class="hidden space-y-5">
                            <div>
                                ...
                                <input type="password" id="admin-token" class="w-full rounded-xl border border-slate-200 px-4 py-3 focus:ring-2 focus:ring-primary/40 focus:border-transparent transition-all text-slate-900" placeholder="请输入管理员 Token" autocomplete="off" required>
                            </div>
